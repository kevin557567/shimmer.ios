...
#define SS_CIPHER_MAP(V)                                                       \
    ...
    V(15, ss_cipher_salsa20,           "salsa20",           8, 32)             \
    V(16, ss_cipher_chacha20,          "chacha20",          8, 32)             \
    V(17, ss_cipher_chacha20ietf,      "chacha20-ietf",    12, 32)             \
    V(18, ss_cipher_aes_128_gcm,       "aes-128-gcm",       0,  0)             \
    V(19, ss_cipher_aes_192_gcm,       "aes-192-gcm",       0,  0)             \
    V(20, ss_cipher_aes_256_gcm,       "aes-256-gcm",       0,  0)             \
    V(21, ss_cipher_chacha20_ietf_poly1305,  "chacha20-ietf-poly1305",  0, 0)  \
    V(22, ss_cipher_xchacha20_ietf_poly1305, "xchacha20-ietf-poly1305", 0, 0)  \
...
#define SSR_PROTOCOL_MAP(V)                                                    \
    ...
    V( 2, ssr_protocol_auth_simple,     "auth_simple")                         \
    V( 3, ssr_protocol_auth_sha1,       "auth_sha1")                           \
    V( 4, ssr_protocol_auth_sha1_v2,    "auth_sha1_v2")                        \
    V( 5, ssr_protocol_auth_sha1_v4,    "auth_sha1_v4")                        \
    V( 6, ssr_protocol_auth_aes128_md5, "auth_aes128_md5")                     \
    V( 7, ssr_protocol_auth_aes128_sha1,"auth_aes128_sha1")                    \
    V( 8, ssr_protocol_auth_chain_a,    "auth_chain_a")                        \
    V(9, ssr_protocol_auth_chain_b,    "auth_chain_b")                        \
    V(10, ssr_protocol_auth_chain_c,    "auth_chain_c")                        \
    V(11, ssr_protocol_auth_chain_d,    "auth_chain_d")                        \
    V(12, ssr_protocol_auth_chain_e,    "auth_chain_e")                        \
    V(13, ssr_protocol_auth_chain_f,    "auth_chain_f")                        \
